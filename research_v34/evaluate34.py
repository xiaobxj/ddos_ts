...
def main():
    ...
    finish(run,files,primary_contrasts=60,histories=11,methods=6,seed_fusion_rules_changed=False,calibration_fits=0,historical_extension=True,independent_holdout=False)
