...
def main():
    ...
    save(OUT/'primary_comparisons.json',pairs);files.append(OUT/'primary_comparisons.json');assert len(pairs)==64
    finish(run,files,primary_contrasts=64,histories=7,methods=6,seed_fusion_rules_changed=False,calibration_fits=0,historical_extension=True,independent_holdout=False)
