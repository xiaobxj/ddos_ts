"""Annual time-weighted convex heads in frozen neural and interaction coordinates."""
...
def old_evidence():
    ...
    p=PREV/'results/delivery_manifest.json';r[str(p.relative_to(PROJECT))]=sha(p);assert len(r)==6056
