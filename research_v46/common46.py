...
import numpy as np
import pandas as pd
ROOT=Path(__file__).resolve().parent;PROJECT=ROOT.parent;OUT=ROOT/'results';PREV=PROJECT/'research_v45';Q39=PROJECT/'research_v39'
...
def input_hashes():
    paths=[a for a,b in COPIES]+[PREV/'protocol.json']+[PREV/'results'/n for n in ['preparation_manifest.json','delivery_manifest.json','verification.json','结果解读与下一步.md','correction_heads.json','correction_parameters.csv']]
