...
def main():
    ...
    for phase in sys.argv[1:]:
        ...
        with path.open('w',encoding='utf-8') as log:
            p=subprocess.Popen([exe,'-B','-u',str(ROOT/f'{phase}39.py')],cwd=ROOT.parent,stdout=subprocess.PIPE,stderr=subprocess.STDOUT,text=True,encoding='utf-8',errors='replace')
