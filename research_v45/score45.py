...
def main():
    ...
    en=pd.DataFrame(ensemble_rows)[be.columns];assert len(en)==3264;ensemble=pd.concat([be,en],ignore_index=True);assert len(ensemble)==40800 and ensemble.history.nunique()==25
    files=[]
